...
void USW_AbilitySystemComponent::AddCharacterAbilities(const TArray<TSubclassOf<UGameplayAbility>>& AbilitiesToGrant)
{
...
void USW_AbilitySystemComponent::AddCharacterPassiveAbilities(
...
void USW_AbilitySystemComponent::InitializeDefaultAttribute(const TSubclassOf<UGameplayEffect> AttributeEffect)
{
